...
import { Box as RadixThemesBox, Button as RadixThemesButton, Dialog as RadixThemesDialog, Flex as RadixThemesFlex, Heading as RadixThemesHeading, Text as RadixThemesText, Theme as RadixThemesTheme } from "@radix-ui/themes"
...
export function Flex_87ed98fe3e8f9edd7edb32b8d9a67cf1 () {
  const [addEvents, connectErrors] = useContext(EventLoopContext);
  ...
  {state__dynamic_form_state.form_data.map((data, index) => (
  <RadixThemesBox key={index}>
  <RadixThemesFlex align={`start`} css={{"paddingTop": "10%"}} direction={`column`} gap={`2`}>
  <RadixThemesHeading>
  {state__dynamic_form_state.form_data.at(index)["Title"]}
</RadixThemesHeading>
  <RadixThemesText as={`p`}>
  {state__dynamic_form_state.form_data.at(index)["Description"]}
</RadixThemesText>
...
export default function Component() {
  ...
  <Flex_87ed98fe3e8f9edd7edb32b8d9a67cf1/>
  <NextHead>
  <title>
